      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <h2 className="mt-4 font-heading font-black tracking-tighter text-4xl sm:text-5xl text-white">
            Najnowsze <span className="text-[#ff007f] neon-text-pink">drops</span>
          </h2>
          <p className="mt-4 text-zinc-400 font-body max-w-xl mx-auto">
            Limitowane projekty łączące japońską estetykę z polskim rzemiosłem.
          </p>
        </div>
        ...
        {!loading && products.length === 0 && (
          ...
          >
            Brak produktów do wyświetlenia. Sprawdź połączenie ze Shopify.
          </div>
        )}
