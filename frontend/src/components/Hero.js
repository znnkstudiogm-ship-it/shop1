    ...
    >
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-6 text-center flex flex-col items-center">
        <span
          ...
          className="rise text-[11px] tracking-[0.45em] uppercase text-[#00f0ff] font-body font-semibold mb-6 border border-[#00f0ff]/30 px-4 py-1 neon-border-cyan/50"
        >
          Polska Marka · Japońska Dusza
        </span>
        ...
        >
          TOKYO <span className="text-[#ff007f] neon-text-pink">DREAMS,</span>
          <br />
          POLISH <span className="text-[#00f0ff] neon-text-cyan">SOUL.</span>
        </h1>
        ...
        >
          Limitowane kolekcje streetwearu inspirowane ulicami Shinjuku, kaligrafią i kwiatem wiśni.
          Szyte z dbałością, noszone z dumą.
        </p>
